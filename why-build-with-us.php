...
<section class="wb-apart-section">
    <div class="wb-container">
        <div class="wb-apart-card" data-anim="fadeIn">
            <!-- Top area: image + heading -->
            <div class="wb-apart-top">
                <div class="wb-apart-img">
                    <img src="<?php echo asset('images/why-build/images-2.webp'); ?>" alt="Living Room Interior Detail" loading="lazy">
                    <span class="wb-apart-corner-tl"></span>
                    <span class="wb-apart-corner-br"></span>
                    <span class="wb-apart-img-tag">Living Room &middot; Interior Detail</span>
                </div>
            ...
            <!-- Divider -->
            <div class="wb-apart-divider"></div>
