...
$PAGE_TITLE = 'One Storey House Designs | Nivi Homes';
...
<section class="ss-filter">
    <div class="container">
        ...
        <div class="ss-filter-group">
            <h4>Bath Rooms:</h4>
            <div class="ss-opts">
                <button class="ss-opt" data-key="bed" data-val="3">3 BHK</button>
                <button class="ss-opt" data-key="bed" data-val="4">4 BHK</button>
