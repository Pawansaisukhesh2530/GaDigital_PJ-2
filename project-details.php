...
$ic_name = '<svg viewBox="0 0 24 24" width="45" height="45" fill="none" stroke="currentColor" stroke-width="1.4" stroke-linecap="round" stroke-linejoin="round"><path d="M3 10.5 12 3l9 7.5"/><path d="M5 9.5V21h14V9.5"/><path d="M9 21v-6h6v6"/></svg>';
$ic_area = '<svg viewBox="0 0 24 24" width="45" height="45" fill="none" stroke="currentColor" stroke-width="1.4" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="3" width="18" height="18" rx="1"/><path d="M3 9h3M3 15h3M18 3v3M9 3v3M21 9h-3M21 15h-3M18 21v-3M9 21v-3"/></svg>';
$ic_type = '<svg viewBox="0 0 24 24" width="45" height="45" fill="none" stroke="currentColor" stroke-width="1.4" stroke-linecap="round" stroke-linejoin="round"><path d="M3 21h18"/><path d="M5 21V7l8-4v18"/><path d="M19 21V11l-6-4"/><path d="M9 9v.01M9 12v.01M9 15v.01M9 18v.01"/></svg>';
$ic_loc  = '<svg viewBox="0 0 24 24" width="45" height="45" fill="none" stroke="currentColor" stroke-width="1.4" stroke-linecap="round" stroke-linejoin="round"><path d="M20 10c0 6-8 12-8 12s-8-6-8-12a8 8 0 0 1 16 0z"/><circle cx="12" cy="10" r="3"/></svg>';
    ...
    <div class="container">
        <div class="pj-gallery">
            ...
            <a class="pj-gallery-item" href="<?php echo e($src); ?>" data-lightbox="<?php echo e($src); ?>">
                <img src="<?php echo e($src); ?>" alt="<?php echo e($prj['title']); ?>" loading="lazy">
            </a>
            <?php endforeach; ?>
        </div>
    </div>
